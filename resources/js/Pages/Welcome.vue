...
import Reactive from '@js/Components/Reactive.vue';
    ...
    <ApplicationLayout>
        ...
        <div class="absolute top-4 right-4 flex items-center gap-4">
            ...
            <button
                ...
                v-tooltip="`Theme`"
                class="size-8 flex items-center justify-center rounded-brand border border-color-300 bg-100 active:translate-y-0.5"
            >
                <SunIcon v-if="themeStore.currentTheme === 'light'" class="shrink-0 size-4" />
                <MoonIcon v-if="themeStore.currentTheme === 'dark'" class="shrink-0 size-4" />
                <SunMoonIcon v-if="themeStore.currentTheme === 'system'" class="shrink-0 size-4" />
            </button>
        </div>
